...
// if no edges made it out, return without posting the surface
	...
	pplane = fa->plane;
#if NSPIRE_CHEAP_ZICACHE
	if( s_r_render_face_cached_plane.i_modelorg_id == r_modelorg_count && s_r_render_face_cached_plane.ps_pplane == pplane )
	{
	...
	// FIXME: cache this?
		...
		s_r_render_face_cached_plane.i_modelorg_id = r_modelorg_count;
#if NSPIRE_CHEAP_ZICACHE
	}
#endif
